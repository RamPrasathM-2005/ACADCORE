// models/departmentAcademic.js (to avoid conflict with HR Department)
module.exports = (sequelize, DataTypes) => {
  const DepartmentAcademic = sequelize.define('department', {
    Deptid: { type: DataTypes.INTEGER, primaryKey: true, allowNull: false },
  ...
  // Seed initial data (use in a seeder script)
  DepartmentAcademic.bulkCreate([
